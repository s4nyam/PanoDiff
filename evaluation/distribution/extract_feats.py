"""One Inception pass per image set -> cached features for FID, KID, IS and precision/recall.
...
SETS = [
    ("1",   f"{LEG}/1-TrainingDataInLR", None), ("2", f"{LEG}/2-DiffLR", None),
    ("3",   f"{LEG}/3-GANsLR", None),           ("4", f"{LEG}/4-DiffHATSR", None),
    ("5",   f"{LEG}/5-GANsHATSR", 7243),        ("6ft", f"{NEW}/6ft-DiffSwinIRft", None),
    ("7ft", f"{NEW}/7ft-GANsSwinIRft", None),   ("8", f"{LEG}/8-TrainHATSR", None),
    ("9ft", f"{NEW}/9ft-TrainSwinIRft", None),  ("10", f"{LEG}/10-TrainDataInHR", None),
    ("6",   f"{LEG}/6-DiffSwinIR", None),       # released-weights SwinIR: protocol check only
]

...
def main(args):
    ...
    tfms = transforms.Compose([
        transforms.Resize((args.resolution, 2 * args.resolution)),
    ...
    for epoch in range(args.num_epochs):
        model_dir = "trained_models/ddpm-model-ep{}.pth".format(epoch)
        ...
        # del model_state, ema_model_state, optimizer_state  # Free memory
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir",
                        type=str,
                        default="trained_models/ddpm-model.pth")
    ...
    parser.add_argument("--save_model_steps", type=int, default=20000)
    parser.add_argument("--gradient_accumulation_steps", type=int, default=1000)
